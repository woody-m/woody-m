...
My technical growth follows a clear progression:
	•	Programming logic and web fundamentals
	•	Frontend development (HTML, CSS, JavaScript)
	•	Backend development and API design
	•	Software architecture and version control best practices
	•	Computer networking (CCNA-level fundamentals)
	•	Defensive cybersecurity and threat management
	•	Security integration across the software lifecycle
...
Security & Networking
	...
	•	Vulnerability assessment and incident response concepts
...
(organized to highlight full-stack and security evolution)

💻 Frontend & Web Development
	•	Introduction to Web Development with JavaScript
	•	JavaScript Fundamentals
	•	Arrays, Control Structures & Functions in JavaScript
...
🔐 Networking & Cybersecurity — Cisco Networking Academy
	...
	•	Network Technician Career Path — Final Exam — Sep 2025
...
🔐 SecureAuth JS
A secure authentication API built with Node.js, JWT, and bcrypt, focusing on:
	•	access control
...
🌱 Current Learning & Next Steps
	•	DevSecOps practices
	•	Security-aware development pipelines
...
<p align="right">
  <img src="https://raw.githubusercontent.com/woody-m/woody-m/refs/heads/main/Brunawoodymila.png" 
       width="120" 
       alt="Bruna Woodymila Fofo">
</p>
